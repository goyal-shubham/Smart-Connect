...
<div id="header-featured">
	<div id="WelcomeName"><h1>Let's Connect you ! </h1> </div>
 </div>
...
<div id="Geo_popup" >
	...
	<div class="form-header">Choose the Specific details<i class="fa fa-times close"></i></div>
		...
		<div class="form-grp">
			<label>City</label>
			<select name="qualification" class="SelectCity" id="qualificationS">
		...
		<div class="form-grp">
			<label>Major</label>
					<select name="qualification" class="SelectMajor" id="qualificationM">
					<option selected="selected" value="1">Computer Science Engieering</option>
		  ...
		  <div class="form-grp">
			<a href="../GoeSuggestions/GeoSuggestions.html"><input class="GeoGo" type="submit" value="Go!"/></a>
