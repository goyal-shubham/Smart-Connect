...
<div id="wrapper">
  <div id="featured-wrapper">
    <div id="featured" class="container">
      ...
      <div class="column2"><a href="<%= response.encodeUrl(request.getContextPath() + "/chatServlet?action=chat") %>"> <span class="icon icon-comments"></span>
        <div class="title">
      ...
      <div class="column3"><a href="#"> <span class="icon icon-road"></span>
        ...
        <p>This Application allows you to play games online with your connected friends Enjoy!!.</p>
      </div>
      <div class="column4"><a href="../Connect/Connect.html" > <span class="icon icon-group"></span>
        <div class="title">
          <h2>Connect</h2>
        </div></a>
        <p>Lets get you Connected to new people you might be interested in.</p>
      </div>
    </div>
  </div>
  <div id="extra" class="container">
    <h2>Welcome to Smart Random Connect</h2>
    <span>One truly dedicated application</span> 
